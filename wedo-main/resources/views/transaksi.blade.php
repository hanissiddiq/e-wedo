                ...
                <table class="table table-hover table-sm table-striped table-bordered table-responsive-sm" id="example3">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td class="text-center align-middle"><a class="btn btn-success btn-sm mb-1 w-100" href="https://wa.me/62{{$data->no_hp}}" >WhatsApp</a><br><a class="btn btn-warning btn-sm mb-1 w-100" href="{{url('purchase/detail/'.$data->id)}}" >Edit</a><br><a class="btn btn-danger btn-sm w-100" href="{{url('purchase/'.$data->id)}}" onclick="return confirm('Yakin Menghapus Data?')">Hapus</a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
