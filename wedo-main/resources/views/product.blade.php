    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="content">
               ...
               @endphp
                <p align="left">  
                    <a href="{{url('product/add')}}" class="btn btn-sm btn-primary font-weight-bold"><span><i class="fa fa-plus"></i> <span class="d-none d-sm-inline-block"> Tambah Produk Baru</span></span></a>
                </p>
                <table class="table table-hover table-sm table-striped table-bordered table-responsive-sm" id="example3">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td class="text-center align-middle"><div class="btn btn-success w-100">Rp. {{number_format($data->harga)}}</div></td>
                          <td class="text-center"><a class="btn btn-warning btn-sm mb-1 w-100" href="{{url('product/detail/'.$data->id)}}" >Edit</a><br><a class="btn btn-danger btn-sm w-100" href="{{url('product/'.$data->id)}}" onclick="return confirm('Yakin Menghapus Data?')">Hapus</a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
