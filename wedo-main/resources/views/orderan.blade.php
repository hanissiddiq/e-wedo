...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div id="page">
	<nav class="fh5co-nav bg-dark" role="navigation" style="background-color: black"> 
		<div class="container">
			<div class="row">
				<div class="col-xs-2">
										...
										<div class="row g-4">
											...
											<div class="text-start">
												<h1>Daftar Orderan</h1>
													...
													<table class="table table-striped" id="example" style="color:black">
																<thead>
																  <tr>
																...
																<tbody>
																  ...
																  <tr>
																	  ...
																	  <td class="text-center">{{$data->nama_wo}}</td>
																	  ...
																	  <td class="text-center"><p class="btn {{$class_status}}">{{$data->status}}</p></td>
